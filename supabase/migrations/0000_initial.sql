...
-- =============================================================================
-- Analytics snapshots (JSONB) — restored; source for the analytics dashboard
-- =============================================================================
...
-- =============================================================================
-- Family sharing — restored. Mutual-permission workflow preserved.
--   invite -> invitee accepts (status 'pending_owner') -> owner confirms
--   ('accepted'). Only then does shared-analytics read unlock.
-- Writes to family_members flow exclusively through the SECURITY DEFINER RPCs
-- below; clients get no direct INSERT/UPDATE grant, which is what enforces the
-- mutual handshake (fixes the legacy default-'accepted' drift).
-- =============================================================================
